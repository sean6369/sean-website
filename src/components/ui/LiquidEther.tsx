...
export default function LiquidEther({
    ...
    useEffect(() => {
        ...
        // Convert backgroundColor to Vector4
        let bgVec4: THREE.Vector4;
        if (backgroundColor === 'transparent') {
            bgVec4 = new THREE.Vector4(0, 0, 0, 0);
        } else {
            const color = new THREE.Color(backgroundColor);
            bgVec4 = new THREE.Vector4(color.r, color.g, color.b, 1);
        }
        ...
        class AutoDriver {
            ...
            update() {
                ...
                // If user has interacted recently, stop auto demo
                if (idle < this.resumeDelay) {
                    if (this.active) this.forceStop();
                    return;
                }

                // Skip the hover check that was preventing auto demo from starting
                // The time-based idle check above is sufficient for our use case
